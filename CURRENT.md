...
Latest work-record update: **2026-09-26T07:30:20.175Z**. This is recorded project state, not a live process monitor.
...
|---|---|---|
| [Operate actual Mini resources through fn correspondence and separate gateways](sprints/2026-09-26/overnight.md) | Sol: fn_contracts, fn_mini_review, fn_reply_profile; Astra: root | Rerun complete exchange on repaired native host using distinct A/B gateway keys; execute direct non-gateway signed-submit refusal and multi-event evidence checks. |
...
| [Host upstream Hermes with persistent confined execution](sprints/2026-09-26/overnight.md) | Sol: hermes_path, replay_session, linux_hosting; review runtime_review; Astra: root | Converge source-owned grain birth, native runtime acceptance and cgroup/sandbox launch with hard/soft disconnect and restart recovery. |
| [Expose canonical resource programming to Hermes](sprints/2026-09-26/checkpoint-1.md) | Sol: hermes_path, replay_session; review runtime_review; Astra: root | Compile and exercise source-owned parent witness and generation-scoped worker law, reconcile interrupted tool phases, and run real Hermes-to-Mini tool acceptance. |
...
| [Retain verified history across native host requests](sprints/2026-09-26/overnight.md) | Sol: mini_receiver, replay_session, client_session; Astra: root | Exercise actual persistent client/host, rollback/replacement poisoning, authority changes and exact receipt recovery on the rebuilt image. |
