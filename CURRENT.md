...
| [Operate real resources through a compiled programmable host](sprints/2026-09-19/cycle-1-integration-checkpoint.md) | Astra: root; Sol: cycle_build + cycle_client | Complete the immutable New World task/content journey and archive its exact source/runtime result; retain separate binary scope for the later proved charge optimization. |
