...
The current design effort is a complete hosted Nous Hermes experience within the September 26 programmable nexus: friends and agents author, govern, share and run DREGG-native resources. Hosted OpenRouter-key custody is acceptable initially; external unforked Hermes access is also desirable. **Implementation is paused for deeper investigation.** Ember rejected Python as a new platform implementation language and reopened the receiving-kernel question. The [Bread/Mini microswarm](sprints/2026-09-19/core-orientation.md) recommends substantive Mini core expansion with selected Bread hosting reuse; this remains a proposal. Read [ember's intentions](intent.md) for accepted choices. The earlier [implementation contract](sprints/2026-09-19/implementation.md) records a superseded wave, not current assignments.
...
| What should we build after the pause? | [Deeper Bread/Mini orientation](sprints/2026-09-19/core-orientation.md): actual resource semantics, deployment gaps and proposed construction order; no new execution |
