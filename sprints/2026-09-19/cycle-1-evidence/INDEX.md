...
The [final Bread continuity push](bread-continuity/final-push.md) records its documentation-only scope and explicit existing dead-reference hook exception. This does not change any native acceptance verdict.
